...
public class JOPAFindTemplateDialog extends JOPADialog<ArrayList<JOPATemplate>> {
	...
	public JOPATemplate selectedTemplate;

	public JOPAFindTemplateDialog(Frame owner, ArrayList<JOPATemplate> templates) {
	...
	private void updateList() {
		...
		for (JOPATemplate template : object) {
